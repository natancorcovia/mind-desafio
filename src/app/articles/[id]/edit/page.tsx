    ...
    <div className="min-h-screen bg-[#0d0d0d] px-6 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8 pb-8 border-b border-[#1e2328]">
          <h1 className="text-2xl font-bold text-white">Editar Artigo</h1>
          ...
          <div className="bg-[#131619] border border-[#1e2328] rounded-lg p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="bg-[#0d0d0d] border border-[#1e2328] text-white text-sm rounded px-3 py-2.5 outline-none focus:border-[#00d4d4] transition-colors"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="bg-[#0d0d0d] border border-[#1e2328] text-white text-sm rounded px-3 py-2.5 outline-none focus:border-[#00d4d4] transition-colors resize-none placeholder:text-white/20"
              />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="bg-[#0d0d0d] border border-[#1e2328] text-white text-sm rounded px-3 py-2.5 outline-none focus:border-[#00d4d4] transition-colors resize-none font-mono leading-relaxed placeholder:text-white/20"
              />
