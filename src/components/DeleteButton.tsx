    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-[#131619] border border-[#1e2328] rounded-lg p-6 w-full max-w-sm shadow-2xl">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-2 border border-[#1e2328] text-white text-sm rounded hover:bg-[#1a1f24] transition-colors"
          >
            Cancelar
          </button>
          <button
            onClick={onConfirm}
            disabled={loading}
            className="flex-1 py-2 bg-red-500 text-white text-sm font-medium rounded hover:bg-red-600 transition-colors disabled:opacity-50"
          >
  ...
  return (
    <>
      <button
        ...
        className={
          isDashboard
            ? "inline-flex items-center gap-1.5 text-xs border border-red-400/20 text-red-400 px-3 py-1.5 rounded hover:bg-red-400/10 transition-colors"
